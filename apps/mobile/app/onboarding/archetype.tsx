    ...
    <SafeAreaView style={styles.screen}>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.row}>
        {archetypes.map((archetype) => (
          <View key={archetype.id} style={[styles.card, selected === archetype.id && styles.selected]}>
            ...
            <BrandButton label={selected === archetype.id ? 'This is me' : 'Select'} variant="secondary" onPress={() => setSelected(archetype.id)} />
          </View>
        ))}
      </ScrollView>
    </SafeAreaView>
